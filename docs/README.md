...
|---------------| -----------------|
|[Project Proposal (FIX ME!)](./p01proposal.md) | This project proposal explores the datasets gathered to study the causes and increased frequencies of wildfires in the United States, as well as what this project can implicate and its limitations. |
